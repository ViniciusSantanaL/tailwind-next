  ...
  return (
    <>
      ...
      <div className="mt-6 flex flex-col ">
        <div className="flex flex-col justify-between gap-5 border-b border-zinc-200 pb-5 dark:border-zinc-700 lg:flex-row lg:items-center">
            ...
            <div className="flex flex-col gap-6 lg:grid lg:grid-cols-2">
              ...
              <div className="flex flex-col gap-3 lg:block">
                ...
                <Input.Root id="lastName">
                  <Input.Control defaultValue="Leão" />
                </Input.Root>
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-col gap-3 pt-5 lg:grid lg:grid-cols-form">
            ...
            <Input.Root>
              ...
              <Input.Control
                id="email"
                type="email"
                defaultValue="viniciussantanaleao@gmail.com"
              />
            </Input.Root>
          </div>
          ...
          <div className="flex flex-col gap-3 pt-5 lg:grid lg:grid-cols-form">
            ...
            <div className="space-y-3">
              <div className="flex flex-col gap-3 lg:grid lg:grid-cols-2">
                <Select defaultValue="normal" placeholder="Select text type...">
